...
const lat = arrArgV[2] === undefined ? 53.122261976193464 : Number(arrArgV[2]);
const lng = arrArgV[3] === undefined ? 17.99897582348337 : Number(arrArgV[3]);
...
const req = fetch(`https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lng}&current=temperature_2m`);
req
